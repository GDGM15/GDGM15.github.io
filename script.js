function showMessage(response) {
  ...
  if (response === "No") {
    ...
    document.getElementsByClassName("image")[0].src = "images/Miniontriste.jpg";
    ...
    noButton.addEventListener("mouseover", () => {
      if (!videoPlayed) {
        ...
        videoElement.src = "./Aime.mp4#t=00";
  ...
  if (response === "Yes") {
    ...
    yesMessage.textContent = "SIII!, Usted y yo tenemos una cita pendiente";
    yesMessage.style.display = "block";
    yesMessage.style.fontStyle = "normal";
    document.getElementsByClassName("image")[0].src = "images/fondo.jpg";

    const dedi = document.getElementById("dedicatoria");
    dedi.textContent = "Te quiero mucho Ely <3, Gracias por estos dos meses, muak";
